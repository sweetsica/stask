...
@section('css')
    <link href="{{ URL::asset('plugins/jvectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" type="text/css" />
@endsection
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group custom-list-group mb-n3">
                                ...
                                <li class="list-group-item align-items-center d-flex justify-content-between">
                                    <div class="media">
                                        <img src="a{{ URL::asset('ssets/images/small/blocks.svg') }}" height="30" class="me-3 align-self-center rounded" alt="...">
                                        <div class="media-body align-self-center">
                            ...
                            <div class="table-responsive browser_users">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/browser_logo/opera.png') }}" alt="" height="16" class="me-2">Opera</td>
                                            <td>1958<small class="text-muted">(31%)</small></td>
                                            <td> 36.82%</td>
                                            <td>361<small class="text-muted">(61%)</small></td>
                                        </tr><!--end tr-->
