...
@section('title') Dashboard @endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Grids @endslot
            @slot('title') Grids @endslot
        @endcomponent
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">Move columns to the right using <code>.offset-md-*</code> classes.
                                ...
                                With the move to flexbox in v4, you can use margin utilities like <code>.me-auto</code>
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 ms-auto"><span class="border py-2 bg-light d-block mb-2">.col-sm-3 ms-auto</span></div>
                                    <div class="col-sm-3 ms-auto"><span class="border py-2 bg-light d-block mb-2">.col-sm-3 ms-auto</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3"><span class="border py-2 bg-light d-block mb-2">.col-sm-3</span></div>
