...
@section('script')
    ...
    <script src="{{ URL::asset('assets/plugins/apex-charts/irregular-data-series.js') }}"></script>
    <script src="{{ URL::asset('assets/plugins/apex-charts/ohlc.js') }}"></script>
    <script src="{{ URL::asset('assets/js/pages/jquery.apexcharts.init.js') }}"></script>
