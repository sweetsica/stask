                    ...
                    <div class="card-body">
                        <div class="kanban-board">
                            <div class="kanban-col">
                                <div class="kanban-main-card">
                                    <div class="kanban-box-title">
                                        <h4 class="card-title mb-3">New Projects</h4>
                                    ...
                                    <button type="button" class="btn btn-block btn-soft-primary">Add Task</button>
                                </div><!--end /div-->
                            </div><!--end kanban-col-->
                            <div class="kanban-col">
                                <div class="kanban-main-card">
                                    <div class="kanban-box-title">
                                        <h4 class="card-title mb-3">To Do</h4>
                                        <div class="dropdown kanban-main-dropdown">
                                            <a class="dropdown-toggle arrow-none" id="drop1" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                                <i class="las la-ellipsis-v font-24 text-muted"></i>
                                            </a>
                            ...
                            <div class="kanban-col">
                                <div class="kanban-main-card">
                                    <div class="kanban-box-title">
                                        <h4 class="card-title mb-3">In Progress</h4>
                                        <div class="dropdown kanban-main-dropdown">
                                            <a class="dropdown-toggle arrow-none" id="drop1" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                                <i class="las la-ellipsis-v font-24 text-muted"></i>
                                            </a>
                            ...
                            <div class="kanban-col">
                                <div class="kanban-main-card">
                                    <div class="kanban-box-title">
                                        <h4 class="card-title mb-3">Code Review</h4>
                                        <div class="dropdown kanban-main-dropdown">
                                            <a class="dropdown-toggle arrow-none" id="drop1" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                                <i class="las la-ellipsis-v font-24 text-muted"></i>
                                            </a>
                            ...
                            <div class="kanban-col">
                                <div class="kanban-main-card">
                                    <div class="kanban-box-title">
                                        <h4 class="card-title mb-3">Done</h4>
                                        <div class="dropdown kanban-main-dropdown">
                                            <a class="dropdown-toggle arrow-none" id="drop1" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                                <i class="las la-ellipsis-v font-24 text-muted"></i>
                                            </a>
...
@section('script')
        ...
        <script src="assets/js/pages/jquery.dragula.init.js"></script>
