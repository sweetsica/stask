...
@section('title') Dashboard @endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Pricings @endslot
            @slot('title') Pricings @endslot
        @endcomponent
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                <img src="{{ URL::asset('assets/images/widgets/p-1.png') }}" alt="" class="" height="120">
                                ...
                                <a href="#" class="btn btn-primary w-100 btn-skew btn-outline-dashed py-2"><span>sign up</span></a>
                            </div><!--end pricingTable-->
                        </div><!--end card-body-->
                    </div> <!--end card-->
                </div><!--end col-->
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                    <span class="badge bg-warning ms-auto a-animate-blink">POPULAR</span>
                                <img src="{{ URL::asset('assets/images/widgets/p-2.png') }}" alt="" class="d-block mx-auto" height="120">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                <img src="{{ URL::asset('assets/images/widgets/p-3.png') }}" alt="" class="" height="120">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                <img src="{{ URL::asset('assets/images/widgets/p-4.png') }}" alt="" class="" height="120">
