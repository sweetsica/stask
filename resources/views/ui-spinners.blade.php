                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="spinner-border spinner-border-custom-3 border-primary" role="status"></div>
                            <div class="spinner-border spinner-border-custom-4 text-primary" role="status"></div>
                            <div class="spinner-border spinner-border-custom-5 border-primary" role="status"></div>
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div> <!-- end col -->
