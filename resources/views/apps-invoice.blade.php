                        ...
                        <div class="card-body invoice-head">
                            <div class="row">
                                <div class="col-md-4 align-self-center">
                                    ...
                                    <img src="{{ URL::asset('assets/images/logo-dark.png') }}" alt="logo-large" class="logo-lg logo-dark" height="20">
                                    <img src="{{ URL::asset('assets/images/logo.png') }}" alt="logo-large" class="logo-lg logo-light" height="20">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6 align-self-end">
                                    <div class="float-end" style="width: 30%;">
                                        ...
                                        <img src="{{ URL::asset('assets/images/signature.png') }}" alt="" class="mt-2 mb-1" height="26">
