...
@section('css')
    <link rel="stylesheet" href="{{ URL::asset('assets/plugins/rating/themes/rating.css') }}">
@endsection
    @section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="text-muted mb-0">jQuery Bar Rating Plugin works by transforming a standard select field into a rating widget.
...
@endsection
@section('script')
        <script src="{{ URL::asset('assets/plugins/rating/jquery.barrating.min.js') }}"></script>
        <script src="{{ URL::asset('assets/js/pages/jquery.rating.init.js') }}"></script>
